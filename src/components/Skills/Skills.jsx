    ...
    <section className="py-16 text-center" ref={ref}>
      ...
      <div class="mt-12 grid gap-8 max-w-md mx-auto md:grid-flow-col md:max-w-none auto-cols-fr">
        <article class="space-y-6">
          ...
          <h3 class="text-green-color text-xl font-bold">HTML5 + FIGMA</h3>
        ...
        <article class="space-y-6">
          ...
          <h3 class="text-green-color text-xl font-bold">CSS + Tailwind</h3>
        ...
        <article class="space-y-6">
          ...
          <h3 class="text-green-color text-xl font-bold">JS + React</h3>
